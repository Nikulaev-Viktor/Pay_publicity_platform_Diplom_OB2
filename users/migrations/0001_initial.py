    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otp_code', models.CharField(blank=True, help_text='Код для подтверждения', max_length=6, null=True, verbose_name='Код подтверждения')),
                ('otp_created_at', models.DateTimeField(blank=True, null=True, verbose_name='Время генерации OTP')),
